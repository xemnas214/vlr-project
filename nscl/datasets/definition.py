...
__all__ = [
    "DatasetDefinitionBase",
    "get_global_definition",
    "set_global_definition",
    "gdef",
]
...
class DatasetDefinitionBase(object):
    ...
    def qtype2atype(self):
        return [
            (name, ret_type)
            for name, _, _, ret_type in self.operation_signatures  # if ret_type in self.return_types
        ]
    ...
    def get_video_folder(self, scene):
        return scene["video_folder"]
